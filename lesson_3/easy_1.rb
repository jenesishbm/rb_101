...
numbers = [1, 2, 2, 3]
numbers.uniq 
# ^ does not mutate numbers, need to use uniq! to do that 
...
> Completely depends on the method (it's part of the method name) but commonly it turns certain methods into mutating methods (i.e. uniq!)
...
# LS: advice.gsub!('important', 'urgent')
advice
...
"Four score and " << famous_words
famous_words.prepend("Four score and ") # LS
